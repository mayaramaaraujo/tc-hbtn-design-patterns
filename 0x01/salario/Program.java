...
public class Program {
    public static void main(String[] args) {
        ...
        System.out.printf(Locale.FRANCE, "Salario 1: %.2f\n", valorSalario1);
        System.out.printf(Locale.FRANCE,"UUID 1: %s\n\n", salarioService1.getUuid());

        System.out.printf(Locale.FRANCE,"Salario 2: %.2f\n", valorSalario2);
        System.out.printf(Locale.FRANCE,"UUID 2: %s\n", salarioService2.getUuid());
    }
}
